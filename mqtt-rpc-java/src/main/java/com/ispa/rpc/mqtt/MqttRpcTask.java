...
public class MqttRpcTask {
    ...
    public MqttRpcTask(ExecutorService executorService, MqttRpcFailureHandler mqttDrpcFailureHandler, TaskBody taskBody) {
    ...
    /**
     * Waits for the completion of the task, or throws a {@link MqttRpcRuntimeException} when the task failed.
     */
    public void join() {
        ...
        if (failure != null) {
            throw new MqttRpcRuntimeException("Task failed, and unable to retry", failure);
        }
    }
